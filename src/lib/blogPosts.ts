...
export const blogPosts: BlogPost[] = [
  {
    slug: 'openrouter-guide-and-monetization',
    title: "I Switched to OpenRouter Six Months Ago — Here's What Nobody Tells You About It",
    date: '2026-07-05',
    ...
    content: `Hi everyone, I am Nitin Gavhane and I want to talk about a tool that quietly changed how I build and charge for AI projects.
...
The monetization path that works fastest: pick a niche where people have a repetitive AI task they're currently doing manually, wrap the right model + prompt in a clean interface, and charge a flat monthly fee. Your infrastructure cost with OpenRouter will be a fraction of what you charge. Start with one use case, get the cost math right, then scale.`,
  ...
  {
    slug: 'everything-claude-code-setup-in-120-seconds',
    title: 'I Wasted 40+ Hours Setting Up Claude Code. This Free Repo Does It in 120 Seconds.',
    date: '2026-07-05',
    readTime: '9 min read',
    category: 'AI',
    excerpt:
    ...
    content: `Hi everyone, I am Nitin Gavhane and in this blog I want to tell you about something that genuinely made me a little annoyed — because I wish I'd found it months earlier.
...
— Nitin Gavhane`,
  ...
  {
    slug: '7-github-repos-make-claude-code-better',
    title: '7 GitHub Repos That Make Claude Code 10x Better',
    date: '2026-07-05',
    readTime: '7 min read',
    category: 'AI',
    excerpt:
    ...
    content: `Hi everyone, I am Nitin Gavhane and in this blog I want to walk you through a handful of GitHub repos I've been poking around in lately, ones that genuinely make Claude more useful day to day. Not a list copy-pasted from somewhere. These are repos I've opened, read, and in most cases actually tried.
...
That's my list for now. If you've found a repo that changed how you use Claude, drop it in the comments — I'm always looking for the next thing to break my setup with.`,
  ...
  {
    slug: 'free-ai-tools-replace-ad-spy-tool',
    title: "I Replaced a $497/Month Ad-Spy Tool With 15+ Free AI Tools (Here's How)",
    date: '2026-07-05',
    readTime: '6 min read',
    category: 'AI',
    excerpt:
    ...
    content: `Hi everyone, I am Nitin Gavhane and in this blog I want to talk about a tool I stumbled on recently that genuinely surprised me: a free MCP server that connects Claude (or any MCP-compatible AI) straight to the Facebook Ads Library.
...
Until next time!`,
  ...
  {
    slug: 'antigravity-opencode-free-ai-coding',
    title: 'AntiGravity Just Became Unstoppable With OpenCode (Free)',
    date: '2026-07-05',
    readTime: '7 min read',
    category: 'Dev',
    excerpt:
...
If you've been looking for a way to bring real AI assistance into your AntiGravity workflow without paying $20 a month for a tool that makes you change your whole setup — OpenCode is worth your afternoon. Install it, connect it to whatever model you have access to, and just try it on a real project. The moment it starts editing your files like it actually read them, something clicks. You'll understand what all the fuss is about.`,
  ...
  {
    slug: '20-things-notebooklm-can-do',
    title: '20 Things NotebookLM Can Do That Most People Never Try',
    date: '2026-07-05',
    readTime: '8 min read',
    category: 'AI',
    excerpt:
    ...
    content: `Hi everyone, I am Nitin Gavhane and in this blog, I'm going to show you how to actually use NotebookLM.
...
If you've found prompts that work better than these, I'd genuinely like to hear them. Drop them in the comments.`,
  ...
  {
    slug: '7-github-repos-cut-scraping-time',
    title: '7 GitHub Repos That Cut My Scraping Time by 80%',
    date: '2026-07-05',
    readTime: '5 min read',
    category: 'Dev',
    excerpt:
    ...
    content: `Hi everyone, I am Nitin Gavhane, and in this blog I want to share a list I've been keeping for a while now: GitHub repos for scraping that I actually open and use, not ones I bookmarked once and forgot about.
...
That's the list. I'll probably add to this as I find new tools worth trusting. If you've been using something I haven't mentioned here, drop it in the comments — I'm always looking for the next one to add to my toolbox.`,
  ...
  {
    slug: 'glm-5-2-free-open-weight-model',
    ...
    content: `Hi everyone, I am Nitin Gavhane and in this blog I want to walk you through GLM-5.2, the new open-weight model from Z.ai. I'll keep this simple and practical: what it actually does, a real example I ran myself, and a step-by-step way to try it for free, whether or not you know how to code.
